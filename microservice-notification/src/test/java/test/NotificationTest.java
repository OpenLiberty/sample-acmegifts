...
public class NotificationTest {
    ...
    public void testNotification() throws Exception {
        ...
        payload.add(JSON_KEY_NOTIFICATION,
        ...
        try {
            ...
            assertTrue("Not all notifications were found. Found: notification1: " + notification1Found
                    + "notification2: " + notification2Found, (notification1Found && notification2Found));
        } finally {
            br.close();
        }
    }
