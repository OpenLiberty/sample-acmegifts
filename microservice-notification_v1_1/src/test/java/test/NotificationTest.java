...
public class NotificationTest {
    /**
     * The twitter handle (AKA ID/UserName) of the user you wish to receive
     * notifications. It must be a valid/active twitter handle.
     */
    private final String twitterRecepientHandle = "CHANGE_ME";

    /**
     * The name of the twitter user associated with the handle shown under
     * twitterRecepientHandle. It can be anything.
     */
    ...
    /**
     * Tests sending a twitter post and a direct notification. IMPORTANT: Update
     * the variables with value: CHANGE_ME before enabling this test.
     */
    // @Test
    public void testTwitterPostMention() throws Exception {
        ...
        content.add(JSON_KEY_MESSAGE, "Merry Christmas " + userMention + "." + System.getProperty("line.separator") 
    ...
    public void testInvalidTwitterRecepientHandle() throws Exception {
        ...
        content.add(JSON_KEY_MESSAGE, "Happy New Year " + twitterRecepientName + System.getProperty("line.separator")
    ...
    public Response processRequest(String url, String method, String payload)
        ...
        builder.header(HttpHeaders.AUTHORIZATION, "Bearer " + new JWTVerifier().createJWT("fred", new HashSet<String>(Arrays.asList("orchestrator"))));
