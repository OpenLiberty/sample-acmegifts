...
public class NotificationResource {
    ...
    Logger logger = Logger.getLogger("net.wasdev.sample.microprofile.notification.NotificationResource");
    Logger fbLogger = Logger.getLogger("net.wasdev.sample.microprofile.notification.NotificationFallbackHandler");
