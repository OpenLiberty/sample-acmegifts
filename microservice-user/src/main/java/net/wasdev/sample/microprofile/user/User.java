...
public class User {
    ...
    /** 
     * Constructor for reading the user from the JSON that was a part of
     * a JAX-RS request.
     */
     ...
     *
     * @param name
     *            The user name as reported by Twitter. We will try to parse
     *            this into a first and last name. This value may be null.
     * @param twitterHandle
     *            The twitter user's name. This will become the user name for
     *            the user.
     * @return A partial User object. The user will need to edit their profile
     *         to complete it.
     */
    ...
    /**
     * Return a JSON object suitable to be returned to the caller with no
     * confidential information (like password or salt).
     */
    ...
    /**
     * Return a DBObject that can be used for updating the user in the mongo
     * database. We only include the fields that the client should be changing
     * (leave out the internal fields).
     */
