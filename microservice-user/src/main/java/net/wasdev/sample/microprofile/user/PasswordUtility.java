...
/**
 * This utility class generates password salt values, and hashes the password
...
public class PasswordUtility {
	...
	/**
	 * Salt value prepended to password bytes to make it harder for someone to
	 * look up passwords stored in the database using a 'rainbow table'.  Each
	 * password gets a unique salt value.
	 */
	...
	/**
	 * Take a cleartext password and generate a salt and the hashed password that
	 * we'll put in the database.
