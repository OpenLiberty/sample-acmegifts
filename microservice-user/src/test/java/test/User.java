...
/**
 * User Data that a client would send to the server.  This object has a
 * different format than the one the server would store.
 */
public class User {
    ...
    public User(String id, String firstName, String lastName, String userName, String twitterHandle, String wishListLink, String password) {
        this.id = id;
    ...
    public boolean isEqual(BasicDBObject other) {
        ...
        return (id.equals(other.getString(DB_ID)) 
                ...
                && hashedPassword.equals(other.get(JSON_KEY_USER_PASSWORD))) ? true : false;
    }
