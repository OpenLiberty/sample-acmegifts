...
public class LoginResourceTest {
    ...
    public void testLogin() throws Exception {
        ...
        User user = new User(null, "Niels", "Bohr", "nBohr", "@nBohr", "nBohrWishListLink", "myPassword");
        ...
        assertTrue("The database user ids for the specified user did not match.",
    ...
    /**
     * Tests the login function with a JWT in the wrong group.  We should not
     * be able to log in.
     */
    @Test
    ...
    public void testLoginNonSsl() throws Exception {
        ...
        response = processRequest(postUrl, "POST", loginPayload.build().toString(), authHeader);
        assertEquals("HTTP response code should have been 302.",
                302, response.getStatus());
    }
