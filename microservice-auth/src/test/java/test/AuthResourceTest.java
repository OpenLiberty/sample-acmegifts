...
public class AuthResourceTest {
    ...
    /**
     * This is the SSL port that the Liberty auth server is listening on.
     * We'll use it to call JAX-RS services in our tests.
     */
    ...
    /**
     * Tests the JWT we get back from the auth service is valid.
     * We test the JWT to make sure it was signed correctly.
     * 
     * We do not validate other things, like the issued at time,
     * expired time, etc.
     * 
     * The test case has access to the keystore that the server
     * should have used to sign the JWT.
     */
    @Test
