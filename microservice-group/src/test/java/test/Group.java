...
public class Group {
     ...
     *
     * @param id The Mongo Object id to assign to this DB Object. If null, a
     *           new Object id will be created
     *
    ...
    public boolean isEqual(BasicDBObject other) {
        ...
        return ((oMembers.containsAll(Arrays.asList(this.members)) && oMembers.size() == this.members.length)
                && this.name.equals(other.get(JSON_KEY_GROUP_NAME)) && this.id.equals(other.getString(DB_ID)));
