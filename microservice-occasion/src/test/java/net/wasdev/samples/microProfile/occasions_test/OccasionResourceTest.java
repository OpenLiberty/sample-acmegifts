...
public class OccasionResourceTest
{
    ...
    public void testGETBadGroup()
    {
        ...
        assertTrue("The check that all occasions are in the db failed. Expected: "
                + expectedCount
                + "\n\nResult:\n\n"
                + count,
                count == expectedCount);
    ...
    public void testPOST()
    {
        ...
        assertTrue("Mismatch in " + name.getMethodName() + ". Expected:\n\n"
                   + expected
                   + "\n\nRecieved:\n\n"
     ...
     *
     * First it creates an occasion then it updates it
     */
    @Test
    public void testPUT()
    {
        ...
        assertTrue(name.getMethodName() + ": PUT result does not match. Expected:\n\n"
                + occasion.toString()
                + "\n\nResult:\n\n"
                + resultOccasion + "\n\n",
    ...
    public void testOccasionsForGroup()
    {
        ...
        Occasion occasion = new Occasion(
         /* ID            */ null,
         /* date          */ "2117-07-31",
         /* group ID      */ "1111", // different ID than the others in this test so it's omitted from the results
         /* interval      */ "annual",
         /* occasion name */ "John Doe's Birthday",
         /* organizer ID  */ "0001",
         /* recipient ID  */ "9998",
    ...
    public void testEndpoint(String endpoint, String requestType, String expectedOutput, int expectedResponseCode)
    {
        ...
        response.close();
        assertTrue("Incorrect response, response is: \n\n" + responseString
                                                  + "\n\n expected: \n\n" + expectedOutput + "\n\n",
    ...
    public String testEndpointReturnJson(String endpoint, String requestType, String expectedOutput, int expectedResponseCode)
    {
        String method = "testEndpointReturnJson";
        logger.entering(clazz, method);
        logger.fine("  endpoint: "             + endpoint);
        logger.fine("  requestType: "          + requestType);
        logger.fine("  expectedOutput: "       + expectedOutput);
        ...
        logger.exiting(clazz, method, "\n\n- - - - - Exiting " + method + " with: " + jsonResponse + "\n\n");
        return jsonResponse;
    }
     */
    ...
    public String testEndpointJson(String endpoint, String requestType, String json, String expectedOutput, int expectedResponseCode)
    {
        ...
        } catch (Throwable t)
        {
            ...
            assertTrue("In " + method + " with unexpected exception: " + t.getMessage(), t instanceof IllegalArgumentException && expectedOutput.equals("IllegalArgumentException"));
        }
