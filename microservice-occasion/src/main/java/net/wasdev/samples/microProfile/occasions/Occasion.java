...
public class Occasion {
    ...
    public static class Contribution {
        ...
        public BasicDBObject toDbo() {
            return new BasicDBObject(OCCASION_CONTRIBUTION_AMOUNT_KEY, amount).append(OCCASION_CONTRIBUTION_USER_ID_KEY,
                    contributionUserId);
        }

        public JsonObject toJson() {
            return Json.createObjectBuilder().add(OCCASION_CONTRIBUTION_AMOUNT_KEY, amount)
                    .add(OCCASION_CONTRIBUTION_USER_ID_KEY, contributionUserId).build();
        }
        ...
        public boolean equals(Object object) {
            ...
            if (null == contribution)
                return false;
            return (getUserId().equals(contribution.getUserId()) && (getAmount() == contribution.getAmount()));
        }
    ...
    public Occasion(ObjectId id, String date, String groupId, String interval, String name, String organizerId,
            String recipientId, List<Contribution> contributions) {
