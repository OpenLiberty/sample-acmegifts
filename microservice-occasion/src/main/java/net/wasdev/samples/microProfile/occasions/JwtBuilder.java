...
/**
 * Liberty provides a JWT builder with static methods that can be used to build a JWT.
 * We are abstracting that out here, so that we can run unit tests without the
 * Liberty runtime in place.
 *
 */
