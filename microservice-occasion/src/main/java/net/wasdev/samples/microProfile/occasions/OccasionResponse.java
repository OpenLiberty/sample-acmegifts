...
public class OccasionResponse {
	...
	public static final String NOTIFICATION_TYPE_ERROR = "Your occasion was processed but a notification request was not sent. The notification service is not available.";
